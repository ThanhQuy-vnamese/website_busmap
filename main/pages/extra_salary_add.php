	  ...
	  <div class="container-full clearfix position-relative">
		...
		<section class="content">
			...
			<form action="" method="post">
                    <?php
                    $userDetail = $user->getDetailUser($id);
                    ?>
					...
					<div class="form-group row">
						<label class="col-form-label col-md-1">Ngày vào làm</label>
                        <div class="col-md-5">
                            <input type="text" value="<?=$userDetail['created_at']?>" disabled class="form-control">
                        </div>
                        <label class="col-form-label col-md-1">Địa chỉ</label>
                        <div class="col-md-5">
                            <input type="text" class="form-control" name="address" disabled value="<?=$userDetail['address']?>">
                        </div>
                    </div>
                    <div class="form-group row">
					<label class="col-form-label col-md-1">Email</label>
                        <div class="col-md-5">
                            <input type="text" class="form-control" name="email" disabled value="<?=$userDetail['email']?>">
						</div>
                        <label class="col-form-label col-md-1">Số điện thoại</label>
                        <div class="col-md-5">
                            <input type="text" class="form-control" name="phone" disabled value="<?=$userDetail['phone']?>">
						</div>
					</div>
					<div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" name="number_day_work" >
                        </div>
					
						<label class="col-form-label col-md-1">Số giờ làm việc/ ngày</label>
                        <div class="col-md-5">
                            <input type="text" class="form-control" name="number_hour_work" >
                        </div>
					</div>
					<div class="form-group row">
                    ...
                    if (isset($_REQUEST['btn-add'])) {
						...
						$number_hour_work= $_REQUEST['number_hour_work'];
						$number_day_work= $_REQUEST['number_day_work'];
						$vat = $_REQUEST['vat'];
						if($payment!='' && $bonus!='' && $allowances !== '' && $number_day_work !== '' && $number_hour_work !== '' && $vat!== '' )
											{
												$d->addnewSalary($id,$payment,$bonus,$allowances, $number_hour_work, $number_day_work, $vat);
