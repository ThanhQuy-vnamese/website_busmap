                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-5">
                            <select name="permission" id="permission" class="form-control">
                                <option value="1" disabled <?php if ($userDetail['permission'] == '1') { echo 'disabled'; } ?>>Admin</option>
                                <option value="2" <?php if ($userDetail['permission'] == '2') { echo 'selected'; } ?>>Tài xế</option>
                                <option value="3" <?php if ($userDetail['permission'] == '3') { echo 'selected'; } ?>>Nhân viên bán vé</option>
                                <option value="4" <?php if ($userDetail['permission'] == '4') { echo 'selected'; } ?>>Quản Lý nhân sự</option>
								<option value="5" <?php if ($userDetail['permission'] == '5') { echo 'selected'; } ?>>Khách hàng</option>
								<option value="6" <?php if ($userDetail['permission'] == '6') { echo 'selected'; } ?>>Học Sinh, Sinh Viên</option>
                            </select>
                        </div>
