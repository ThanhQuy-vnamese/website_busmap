...
public function getDetailSalary(string $id): array {
    ...
    public function updateSalary($id,$payment,$bonus,$allowances, $number_hour_work, $number_day_work, $vat) {
        ...
        $sqlSelectAfterUpdate = "SELECT id FROM `salaries` WHERE id_user = ${id};";
        $salaryQuery = mysqli_query($connect, $sqlSelectAfterUpdate);
        $salary = mysqli_fetch_array($salaryQuery);
        $id_salary = $salary['id'];

        ((int)$total_salary= ($number_hour_work*$number_day_work*$payment) + $allowances + $bonus- $vat);
    ...
    public function Salary_list($date, $id_user){
        ...
        if($date!='' && $id_user==''){
            ...
            echo'
                    <tr>
                      <td><a href="../chitietluong/chitietluong.php?id='.$row1['id'].'">Nhân Viên #NV'.$row1['id'].'</a></td>
                      <td><a href="../chitietluong/chitietluong.php?id='.$row1['id'].'">'.$row1['full_name'].'</td>
                      <td><a href="../chitietluong/chitietluong.php?id='.$row1['id'].'">'.$row1['email'].'</td>
                      <td><a href="../chitietluong/chitietluong.php?id='.$row1['id'].'"><span class="text-muted"><i class="fa fa-clock-o"></i>'.$row1['created_at'].'</span> </td>
                      <td><a href="../chitietluong/chitietluong.php?id='.$row1['id'].'">'.$row1['number_hour_work'].'</td>
                      <td><a href="../chitietluong/chitietluong.php?id='.$row1['id'].'">'.$row1['number_day_work'].'</td>
                      <td><a href="../chitietluong/chitietluong.php?id='.$row1['id'].'">'.number_format($row1['bonus']).'</td>
                      <td><a href="../chitietluong/chitietluong.php?id='.$row1['id'].'">'.number_format($row1['allowances']).'</td>
                      <td><a href="../chitietluong/chitietluong.php?id='.$row1['id'].'">'.number_format($row1['vat']).'</td>
                      <td><a href="../chitietluong/chitietluong.php?id='.$row1['id'].'">'.number_format($row1['payment']).'</td>
                      <td><a href="../chitietluong/chitietluong.php?id='.$row1['id'].'">'.number_format($row1['total_salary']).'</td>
                    </tr>
                    ';
        }
        }
        elseif($id_user!='' && $date==''){
            ...
            echo'
                    <tr>
                      <td><a href="../chitietluong/chitietluong.php?id='.$row2['id'].'">Nhân Viên #NV'.$row2['id'].'</a></td>
                      <td><a href="../chitietluong/chitietluong.php?id='.$row2['id'].'">'.$row2['full_name'].'</td>
                      <td><a href="../chitietluong/chitietluong.php?id='.$row2['id'].'">'.$row2['email'].'</td>
                      <td><a href="../chitietluong/chitietluong.php?id='.$row2['id'].'"><span class="text-muted"><i class="fa fa-clock-o"></i>'.$row2['created_at'].'</span> </td>
                      <td><a href="../chitietluong/chitietluong.php?id='.$row2['id'].'">'.$row2['number_hour_work'].'</td>
                      <td><a href="../chitietluong/chitietluong.php?id='.$row2['id'].'">'.$row2['number_day_work'].'</td>
                      <td><a href="../chitietluong/chitietluong.php?id='.$row2['id'].'">'.number_format($row2['bonus']).'</td>
                      <td><a href="../chitietluong/chitietluong.php?id='.$row2['id'].'">'.number_format($row2['allowances']).'</td>
                      <td><a href="../chitietluong/chitietluong.php?id='.$row2['id'].'">'.number_format($row2['vat']).'</td>
                      <td><a href="../chitietluong/chitietluong.php?id='.$row2['id'].'">'.number_format($row2['payment']).'</td>
                      <td><a href="../chitietluong/chitietluong.php?id='.$row2['id'].'">'.number_format($row2['total_salary']).'</td>
                    </tr>
                    ';
        }
        }
        ...
        while ($row = mysqli_fetch_array($result3)) {
            echo'
                    <tr>
                      <td><a href="../chitietluong/chitietluong.php?id='.$row['id'].'">Nhân Viên #NV'.$row['id'].'</a></td>
                      <td><a href="../chitietluong/chitietluong.php?id='.$row['id'].'">'.$row['full_name'].'</td>
                      <td><a href="../chitietluong/chitietluong.php?id='.$row['id'].'">'.$row['email'].'</td>
                      <td><a href="../chitietluong/chitietluong.php?id='.$row['id'].'"><span class="text-muted"><i class="fa fa-clock-o"></i>'.$row['created_at'].'</span> </td>
                      <td><a href="../chitietluong/chitietluong.php?id='.$row['id'].'">'.$row['number_hour_work'].'</td>
                      <td><a href="../chitietluong/chitietluong.php?id='.$row['id'].'">'.$row['number_day_work'].'</td>
                      <td><a href="../chitietluong/chitietluong.php?id='.$row['id'].'">'.number_format($row['bonus']).'</td>
                      <td><a href="../chitietluong/chitietluong.php?id='.$row['id'].'">'.number_format($row['allowances']).'</td>
                      <td><a href="../chitietluong/chitietluong.php?id='.$row['id'].'">'.number_format($row['vat']).'</td>
                      <td><a href="../chitietluong/chitietluong.php?id='.$row['id'].'">'.number_format($row['payment']).'</td>
                      <td><a href="../chitietluong/chitietluong.php?id='.$row['id'].'">'.number_format($row['total_salary']).'</td>
                    </tr>
                    ';
        }
    }
    ...
    public function Salary_list2($date, $id_user){
        $connect = $this->connect_database();
        ...
        if($date!='' && $id_user==''){
            ...
            echo'
                    <tr>
                      ...
                      <td><a href="#">'.$row1['full_name'].'</td>
                      <td><a href="#">'.$row1['email'].'</td>
                      <td><a href="#"><span class="text-muted"><i class="fa fa-clock-o"></i>'.$row1['created_at'].'</span> </td>
                      <td><a href="#">'.$row1['number_hour_work'].'</td>
                      <td><a href="#">'.$row1['number_day_work'].'</td>
                      <td><a href="#">'.number_format($row1['bonus']).'</td>
                      <td><a href="#">'.number_format($row1['allowances']).'</td>
                      <td><a href="#">'.number_format($row1['vat']).'</td>
                      <td><a href="#">'.number_format($row1['payment']).'</td>
                      <td><a href="#">'.number_format($row1['total_salary']).'</td>
                    </tr>
                    ';
        }
        }
        elseif($id_user!='' && $date==''){
            ...
            echo'
                    <tr>
                      ...
                      <td><a href="#">'.$row2['full_name'].'</td>
                      <td><a href="#">'.$row2['email'].'</td>
                      <td><a href="#"><span class="text-muted"><i class="fa fa-clock-o"></i>'.$row2['created_at'].'</span> </td>
                      <td><a href="#">'.$row2['number_hour_work'].'</td>
                      <td><a href="#">'.$row2['number_day_work'].'</td>
                      <td><a href="#">'.number_format($row2['bonus']).'</td>
                      <td><a href="#">'.number_format($row2['allowances']).'</td>
                      <td><a href="#">'.number_format($row2['vat']).'</td>
                      <td><a href="#">'.number_format($row2['payment']).'</td>
                      <td><a href="#">'.number_format($row2['total_salary']).'</td>
                    </tr>
                    ';
        }
        }
        ...
        while ($row = mysqli_fetch_array($result3)) {
            echo'
                    <tr>
                      ...
                      <td><a href="#">'.$row['full_name'].'</td>
                      <td><a href="#">'.$row['email'].'</td>
                      <td><a href="#"><span class="text-muted"><i class="fa fa-clock-o"></i>'.$row['created_at'].'</span> </td>
                      <td><a href="#">'.$row['number_hour_work'].'</td>
                      <td><a href="#">'.$row['number_day_work'].'</td>
                      <td><a href="#">'.number_format($row['bonus']).'</td>
                      <td><a href="#">'.number_format($row['allowances']).'</td>
                      <td><a href="#">'.number_format($row['vat']).'</td>
                      <td><a href="#">'.number_format($row['payment']).'</td>
                      <td><a href="#">'.number_format($row['total_salary']).'</td>
                    </tr>
                    ';
        }
    }
