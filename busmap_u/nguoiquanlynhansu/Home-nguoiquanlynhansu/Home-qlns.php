...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="./Home-qlns.css" />
    <link
      rel="stylesheet"
  ...
  <body>
    <div class="container-fluid homepage">
      ...
      <!-- <div class="nav-bar pt-3 pb-3 row">
        <div class="container-fluid">
          <div class="sm-12 col-md-12 col-lg-10">
            <div class="row">
              <div class="col-sm-6 col-md-6 col-lg-2 menu-nav text-center">
                <a href="../theodoichuyenxe-TV/theodoichuyenxe_TV.php" style="font-size: 15px;">Theo dõi chuyến xe</a>
              </div>
              <div class="col-sm-6 col-md-6 col-lg-1 menu-nav text-center">
                <a href="../guihang-TV/guihang_TV.php" style="font-size: 15px;">Gửi hàng</a>
              </div>
              <div class="col-sm-6 col-md-6 col-lg-1 menu-nav text-center">
                <a href="../muavethuong/muavethuong.php" style="font-size: 15px;">Mua vé</a>
              </div>
              <div class="col-sm-6 col-md-6 col-lg-2 menu-nav text-center">
                <a href="../dangkyvethang/dangkyvethang.php" style="font-size: 15px;">Đăng ký vé tháng</a>
              </div>
              <div class="col-sm-6 col-md-6 col-lg-1 menu-nav text-center">
                <a href="../xemlichlamviec/xemlichlamviec.php" style="font-size: 15px;">Lịch làm việc</a>
              </div>
              <div class="col-sm-6 col-md-6 col-lg-1 menu-nav text-center">
                <a href="../xemluong/xemluong.php" style="font-size: 15px;">Lương</a>
              </div>
              <div class="col-sm-12 col-md-12 col-lg-2 menu-nav text-center">
                <a href="../quanlynhanvien/quanlynhanvien.php" style="font-size: 15px;">Quản lý nhân viên</a>
              </div>
            </div>
          </div>
          <div class="sm-12 col-md-12 col-lg-2"></div>
        </div>
      </div> -->
      ...
      <div class="row">
          <div class="col-sm-12 col-md-5 col-lg-5 list-bus pt-3">
            <div class="list-bus-infor">
              ...
              <h5>CÁC TUYẾN XE</h5>
              <span>Click để theo dõi chuyến xe</span>
              <?php
