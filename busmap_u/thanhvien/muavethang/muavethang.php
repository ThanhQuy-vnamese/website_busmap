...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="muavethang.css" />
    <link
      rel="stylesheet"
        ...
        <div class="row">
          ...
          <div class="col-sm-12 col-md-7 col-lg-7 d-flex justify-content-center">
            <div class="border-form">
              ...
              <p class="text-center"><span style="color: red;">số:</span>&nbsp;04062021123</p>
              <h4 class="text-center">VÉ ĐI XE BUÝT</h4>
              <p class="text-center">(Loại vé)</p>
              <p class="text-center"><b>Giá vé:.....000 đồng/lượt</b></p>
              <p class="text-center">Tuyến xe...............</p>
            </div>
          </div>
        </div>
      </div>
