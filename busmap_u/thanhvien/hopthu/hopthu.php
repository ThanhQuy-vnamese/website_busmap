...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="./hopthu.css" />
    <link
      rel="stylesheet"
      ...
      <div class="main-home container">
        <div class="row">
          <div class="col-sm-12 col-md-3 col-lg-3 list-bus pt-3">
            <a href="../thongbao-TV/thongbao_TV.php" style="color: black; text-decoration: none;"><b>Thông báo</b></a>
            <br><a href="./hopthu.php" style="color: black; text-decoration: none;"><b>Góp ý kiến</b></a>
          </div>
          <div class="col-sm-12 col-md-7 col-lg-7 d-flex justify-content-center">
            <form action="" class="form form-gopy mt-4 mb-4">
                <textarea name="" id="" cols="100" rows="7" class="form-control" placeholder="Nhập nội dung..."></textarea>
                <div class="d-flex justify-content-center mt-3">
                    <button type="submit" class="btn btn-success btn-gopy">Góp ý kiến</button>
                </div>
            </form>
          </div>
        </div>
