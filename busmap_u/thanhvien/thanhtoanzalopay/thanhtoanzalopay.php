...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="./thanhtoanzalopay.css" />
    <link
      rel="stylesheet"
  ...
  <body>
    <div class="container-fluid homepage">
      ...
      <div class="main-home container d-flex justify-content-center pt-4 pb-4">
        
        <div class="row main">
            <h4 class="col-sm-12 col-md-12 col-lg-12">CỔNG ZALOPAY</h4>
            <div class="col-sm-12 col-md-12 col-lg-7" style="border: 1px solid;">
                <p>Chọn phương thức thanh toán:</p>
                <div class="PTTT">
                    <p>Thông qua ứng dụng Zalopay</p>
                    <p>VISA</p>
                    <p>Thẻ ATM nội địa</p>
                </div>
            </div>
            <div class="col-sm-12 col-md-12 col-lg-5" style="border: 1px solid;">
                <p>Thông tin thanh toán:</p>
                <div class="TTTT">
                    <p><b>Số tiền thanh toán:</b> <span style="color: green;">...000 Vnđ</span></p>
                    <p><b>Mã giao dịch</b></p>
                    <p style="color: gray;">1234_4567890</p>
                    <p><b>Nội dung:</b></p>
                    <p style="color: gray;">Mua vé xe buýt</p>
                </div>
            </div>
            <p class="col-sm-12 col-md-12 col-lg-12" style="color: red;"><b>x Hủy giao dịch</b></p>
        </div>
        </div>
      </div>
    </div>
