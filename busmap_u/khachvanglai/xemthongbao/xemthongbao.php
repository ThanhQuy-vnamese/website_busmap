...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="./xemthongbao.css" />
    <link
      rel="stylesheet"
        ...
        <div class="row">
          <div class="col-sm-12 col-md-5 col-lg-5 list-bus pt-3">
            <div class="list-bus-infor pr-3">
              ...
              <h5>CÁC THÔNG BÁO</h5>
              <div class="row list-tb mt-3">
                <div class="col-sm-7 col-md-7 col-lg-7"><b>THÔNG BÁO 1</b></div>
                <div class="col-sm-5 col-md-5 col-lg-5 text-right">4 giờ</div>
              </div>
              <div class="row list-tb mt-3">
                <div class="col-sm-7 col-md-7 col-lg-7"><b>THÔNG BÁO 2</b></div>
              ...
              <div class="row list-tb mt-3">
                ...
                <div class="col-sm-5 col-md-5 col-lg-5 text-right"></div>
              </div>
            </div>
          </div>
          <div class="col-sm-12 col-md-7 col-lg-7 mt-4 pl-5">
            <div class="noidungthongbao">
              <p style="color: red;" class="text-center"><i>(Chức năng đang cập nhật)</i></p>
            </div>
          </div>
        </div>
      </div>
