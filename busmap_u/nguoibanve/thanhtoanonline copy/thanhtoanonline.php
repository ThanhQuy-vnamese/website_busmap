...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="./thanhtoanonline.css" />
    <link
      rel="stylesheet"
    ...
    <div class="container-fluid homepage">
      ...
      <div class="main-home container d-flex justify-content-center">
        <div class="border-main">
            <h4 class="text-center">CỔNG ZALOPAY</h4>
            <form action="" class="form formthanhtoanonline">
                <div>
                    <label for="">Số tiền:</label>
                    <input type="text" name="txtsotien" id="" class="form-control">
                </div>
                <div>
                    <label for="">Chọn hình thức thanh toán:</label>
                    <select name="slchinhthucthanhtoanonline" id="" class="form-control">
                        <option value="zalopay">Ứng dụng Zalopay</option>
                ...
                <div class="d-flex justify-content-center">
                    <button type="submit" class="btn btn-success btnthanhtoanonline mt-3">Thanh toán</button>
                </div>
            </form>
        </div>
      </div>
