    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer d-flex justify-content-center">
          <button type="button" class="btn btn-default" data-dismiss="modal"><a href="./thanhtoantienmat.php" style="text-decoration: none; color: black;">Hủy</a></button>
          <button type="button" class="btn btn-default"><a href="../Home/Home.html" style="text-decoration: none; color: black;">Xác nhận</a></button>
        </div>
      </div>
