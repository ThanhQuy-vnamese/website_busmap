...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="./danhsachxebuyt.css" />
    <link
      rel="stylesheet"
  ...
  <body>
    <div class="container-fluid homepage">
      ...
      <div class="main-home container pt-3 pb-3">
        <h4 class="text-center">DANH SÁCH XE BUÝT</h4>
        <div class="row">
            ...
            <div class="col-sm-12 col-md-12 col-lg-2">
                <button class="btn">In danh sách</button>
            </div>
            <div class="col-sm-0 col-md-1 col-lg-1"></div>
            <div class="col-sm-12 col-md-3 col-lg-3">
                <a href="../themxebuyt/themxebuyt.php">Thêm xe buýt mới</a>
            </div>
            <div class="col-sm-0 col-md-1 col-lg-1"></div>
        </div>
        
        <table class="table table-bordered table-hover mt-3">
            <thead style="background-color: rgb(185, 180, 180);">
                <tr>
                <th>STT</th>
                  <th>Loại xe</th>
                  <th>Số xe</th>
		  ...
		  $p->xuatdsxe("select* from buses_numbers inner join buses on buses_numbers.id = buses.id_buses_numbers
       ");
		 ?>
