...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="./themxebuyt.css" />
    <link
      rel="stylesheet"
    ...
    <script
      ...
      crossorigin="anonymous"
    ></script>
    <script src="./themxebuyt.js"></script>
  ...
  <body>
    <div class="container-fluid homepage">
      ...
      <div class="main-home container pt-3 pb-3">
        <h4 class="text-center">THÊM XE BUÝT MỚI</h4>
...
if (isset($_REQUEST['btn-add'])) {
  ...
  if ($plate != '' && $id_buses_numbers != '') {
    $d-> addnewbus($id_buses_numbers,$plate);;
  } else {
...
<div class="main-home container pt-3 pb-3">
<form action="" method="post">
<h4 class="text-center">THÊM TUYẾN XE BUÝT MỚI</h4>
...
<div class="form-group row">
  <label class="col-form-label col-md-2">Thêm</label>
  <button type="submit" class="btn btn-primary mb-5" name="btn-add-2">Thêm tuyến</button>
</div>
...
if (isset($_REQUEST['btn-add-2'])) {
  ...
  if ($bus_number_name != '' && $bus_number != '' ) {
    $d-> addnewbusnumber($bus_number_name, $bus_number);
  } else {
    echo "<script>alert('Vui lòng nhập đầy đủ thông tin!');</script>";
  }
}
