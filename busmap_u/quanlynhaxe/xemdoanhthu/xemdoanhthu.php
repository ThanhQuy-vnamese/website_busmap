...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="./xemdoanhthu.css" />
    <link
      rel="stylesheet"
  ...
  <body>
    <div class="container-fluid homepage">
      ...
      <div class="main-home container pt-3 pb-3" style="height: 500px;">
        <h4 class="text-center">XEM DOANH THU</h4>
        <div class="row mt-3">
          ...
          <form action="" method="post">
										<div class="form-group row">
											...
											<div class="col-md-2">
												<button type="submit" class="btn btn-danger " name="btn-print">xuất file</button>
										...
										if (isset($_REQUEST['btn-add'])) {
											...
											if($date!='' && $id_bus_numbers !=''){
											$d->Revenue_l($date, $id_bus_numbers);
											}
											else echo'Vui lòng chọn đầy đủ thông tin.';
										}
										?>
